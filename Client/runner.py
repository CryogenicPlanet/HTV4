...
def face():
    ...
    while count < 5:
        ...
        for f in faces:
            ...
            files = {'image': base64.b64encode(open(FaceFileName, 'rb').read())}
...
face()
time.sleep(0.3)
os.system("python3 /home/major-league-hacking/htvFridge/food.py")
cv2.destroyAllWindows()
url = "http://35.188.12.206:3000/api/fridge/handshake"
